...
let projects = [
  {
    image: 'textures/project (4).jpg',
    url: 'https://github.com/Ksmart234/Client-system-php/tree/main',
  },
  {
    image: 'textures/project.jpg',
    url: 'https://github.com/Ksmart234/Guest-pass',
  },
  {
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('KSMART', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
